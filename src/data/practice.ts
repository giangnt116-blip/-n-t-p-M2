...
export const PRACTICE_QUESTIONS: Question[] = [
  ...
  {
    id: "D20",
    title: "Trang trại 260 chiếc chân",
    order: 20,
    part: "B",
    status: "available",
    difficulty: 2,
    skills: ["optimization", "constraint", "integer_reasoning"],
    problem: {
      text: "Bác Ben nuôi ba loại con vật:\n\n• Gà: 2 chân\n• Heo: 4 chân\n• Nhện: 8 chân\n\nTổng số chân là 260.\n\nMỗi loại có ít nhất 6 con.\n\nHỏi tổng số con vật ít nhất có thể là bao nhiêu?",
      answerType: "number",
      placeholder: "Nhập tổng số con vật ít nhất...",
      unit: "con",
    },
    answer: {
      type: "numeric",
    ...
    hints: [
      {
        level: 1,
        title: "Ưu tiên loài nhiều chân hay ít chân?",
        cost: "1 sao tư duy",
        text: "Muốn ít con vật, em thích mỗi con có nhiều chân hay ít chân?",
        content: "Muốn ít con vật, em thích mỗi con có nhiều chân hay ít chân?",
      },
      {
        level: 2,
        title: "Ràng buộc tối thiểu với Gà và Heo",
        cost: "2 sao tư duy",
        text: "Nhện có nhiều chân nhất, nhưng vẫn bắt buộc có ít nhất 6 Gà và 6 Heo.",
        content: "Nhện có nhiều chân nhất, nhưng vẫn bắt buộc có ít nhất 6 Gà và 6 Heo.",
      },
      {
        level: 3,
        title: "Bắt đầu từ mức tối thiểu",
        cost: "3 sao tư duy",
        text: "Hãy thử bắt đầu với 6 Gà, 6 Heo rồi dùng Nhện để bù số chân còn thiếu.",
        content: "Hãy thử bắt đầu với 6 Gà, 6 Heo rồi dùng Nhện để bù số chân còn thiếu.",
      },
    ],
    simulation: {
      type: "animalLegLab",
      name: "Phòng thí nghiệm Trang trại Chân động vật",
      config: {
        totalLegs: 260,
        animals: [
          {
        ...
        objective: "minimizeTotalAnimals",
      },
    },
    teachingPoint:
    ...
    explanation: [
      "Bước 1: Muốn ít con vật nhất, loài nào có nhiều chân nhất mỗi con?\n→ Nhện: 8 chân.",
      "Bước 2: Vẫn bắt buộc có ít nhất:\n6 Gà\n6 Heo\n\nNếu tất cả N con đều là Nhện: tối đa có 8N chân.\nNhưng 6 Gà thay cho 6 Nhện làm giảm:\n6 × (8 - 2) = 36\n6 Heo thay cho 6 Nhện làm giảm:\n6 × (8 - 4) = 24\nTổng giảm:\n60\n\nDo đó:\n8N - 60 ≥ 260\n8N ≥ 320\nN ≥ 40",
      "Bước 3: Chỉ ra phương án đạt 40:\nGà = 6\nHeo = 6\nNhện = 28\n\nKiểm tra:\n6×2 + 6×4 + 28×8\n= 12 + 24 + 224\n= 260\n\nTổng số con:\n6 + 6 + 28 = 40\n\nKết luận:\n40 là nhỏ nhất.",
    ],
  },
  {
    id: "D21",
    title: "Thỏ Trắng sống ở tầng nào?",
    order: 21,
    part: "B",
    status: "available",
    difficulty: 2,
    skills: ["distance_reasoning", "equation", "simulation"],
    problem: {
      text: "Thỏ Trắng và Nhím Nâu sống trong một tòa tháp cao 41 tầng.\n\nThỏ đi theo hành trình:\ntầng 1 → nhà Thỏ → nhà Nhím.\n\nBiết:\n• Tổng quãng đường Thỏ đi bằng quãng đường từ tầng 1 lên tầng 41.\n• Tổng quãng đường đó bằng 2 lần khoảng cách từ tầng 1 đến nhà Nhím.\n\nHỏi nhà Thỏ ở tầng nào?",
      answerType: "number",
      placeholder: "Nhập số tầng của Thỏ...",
      unit: "tầng",
    },
    answer: {
      type: "numeric",
    ...
    hints: [
      {
        level: 1,
        title: "Quãng đường từ tầng 1 tới tầng 41",
        cost: "1 sao tư duy",
        text: "Quãng đường từ tầng 1 tới tầng 41 dài bao nhiêu?",
        content: "Quãng đường từ tầng 1 tới tầng 41 dài bao nhiêu?",
      },
      {
        level: 2,
        title: "Tìm tầng của Nhím trước",
        cost: "2 sao tư duy",
        text: "Nếu tổng đường đi gấp đôi khoảng cách từ tầng 1 tới Nhím, em có tìm được tầng của Nhím trước không?",
        content: "Nếu tổng đường đi gấp đôi khoảng cách từ tầng 1 tới Nhím, em có tìm được tầng của Nhím trước không?",
      },
      {
        level: 3,
        title: "Thiết lập phương trình cho R",
        cost: "3 sao tư duy",
        text: "Sau khi biết Nhím ở tầng 21, hãy tìm R sao cho (R-1)+|R-21|=40.",
        content: "Sau khi biết Nhím ở tầng 21, hãy tìm R sao cho (R-1)+|R-21|=40.",
      },
    ],
    simulation: {
      type: "towerJourneyLab",
      name: "Mô hình Tòa tháp Hành trình Thỏ & Nhím",
      config: {
        bottomFloor: 1,
        topFloor: 41,
        rabbitUnknown: true,
        hedgehogUnknown: true,
      },
    },
    teachingPoint:
      "Hãy chuyển câu chuyện về quãng đường thành các đoạn có độ dài cụ thể.",
    explanation: [
      "Bước 1: Tìm tầng của Nhím Nâu:\n• Quãng đường từ tầng 1 lên tầng 41 là: 41 - 1 = 40 (đoạn tầng).\n• Tổng quãng đường Thỏ đi bằng 40.\n• Tổng quãng đường này gấp đôi khoảng cách từ tầng 1 tới Nhím:\n⇒ Khoảng cách từ tầng 1 tới Nhím = 40 : 2 = 20.\n⇒ Nhím sống ở tầng: 1 + 20 = 21.",
      "Bước 2: Xác định vị trí Thỏ so với Nhím:\n• Thỏ đi hành trình: 1 → R → 21 với tổng quãng đường bằng 40.\n• Nếu Thỏ ở tầng R ≤ 21, Thỏ chỉ đi một chiều lên Nhím: (R - 1) + (21 - R) = 20 ≠ 40.\n⇒ Thỏ bắt buộc phải sống ở phía trên Nhím (R > 21).",
      "Bước 3: Thiết lập phương trình khi R > 21:\n(R - 1) + (R - 21) = 40\n2R - 22 = 40\n2R = 62\nR = 31\n\nKiểm tra lại: (31 - 1) + (31 - 21) = 30 + 10 = 40.\n\nKết luận: Thỏ Trắng sống ở tầng 31.",
    ],
  },
  {
    id: "D22",
    title: "Bí mật trong cuốn lịch tháng 8",
    order: 22,
    part: "B",
    status: "available",
    difficulty: 2,
    skills: ["cycle", "calendar_logic", "elimination"],
    problem: {
      text: "Một tháng 8 có đúng 3 ngày Chủ Nhật rơi vào ngày chẵn.\n\nHỏi ngày 9 tháng 8 là thứ mấy?",
      answerType: "single-choice",
      choices: [
        { id: "Thứ Hai", label: "Thứ Hai" },
      ...
      placeholder: "Chọn thứ cho ngày 9 tháng 8...",
    },
    answer: {
      type: "text",
      value: "Chủ Nhật",
    ...
    hints: [
      {
        level: 1,
        title: "Khoảng cách giữa các Chủ Nhật",
        cost: "1 sao tư duy",
        text: "Các ngày Chủ Nhật liên tiếp cách nhau bao nhiêu ngày?",
        content: "Các ngày Chủ Nhật liên tiếp cách nhau bao nhiêu ngày?",
      },
      {
        level: 2,
        title: "Tính chất chẵn / lẻ khi cộng 7",
        cost: "2 sao tư duy",
        text: "Cộng 7 sẽ làm ngày chẵn thành ngày lẻ và ngược lại.",
        content: "Cộng 7 sẽ làm ngày chẵn thành ngày lẻ và ngược lại.",
      },
      {
        level: 3,
        title: "Thử 3 trường hợp đầu tiên",
        cost: "3 sao tư duy",
        text: "Hãy thử Chủ Nhật đầu tiên là ngày 1, ngày 2 hoặc ngày 3.",
        content: "Hãy thử Chủ Nhật đầu tiên là ngày 1, ngày 2 hoặc ngày 3.",
      },
    ],
    simulation: {
      type: "calendarLogicLab",
      name: "Phòng thí nghiệm Lịch Tháng 8",
      config: {
        month: 8,
        days: 31,
    ...
    explanation: [
      "Bước 1: Quy luật chu kỳ của các ngày cùng thứ:\n• Các Chủ Nhật trong tháng cách nhau đúng 7 ngày.\n• Nếu Chủ Nhật đầu tiên là ngày S, các Chủ Nhật tiếp theo sẽ là: S, S + 7, S + 14, S + 21, S + 28 (miễn là không vượt quá 31).",
      "Bước 2: Phân tích số lượng Chủ Nhật trong tháng:\n• Vì cộng 7 sẽ làm chẵn biến thành lẻ và ngược lại (Chẵn + Lẻ = Lẻ, Lẻ + Lẻ = Chẵn).\n• Do đó, các ngày Chủ Nhật sẽ xen kẽ chẵn / lẻ liên tiếp.\n• Nếu tháng chỉ có 4 Chủ Nhật: dù bắt đầu là chẵn hay lẻ, cũng chỉ có đúng 2 ngày chẵn và 2 ngày lẻ.\n• Muốn có đúng 3 Chủ Nhật rơi vào ngày chẵn, tháng bắt buộc phải có 5 Chủ Nhật và ngày Chủ Nhật đầu tiên phải rơi vào ngày chẵn.\n• Trong tháng có 31 ngày, để có 5 Chủ Nhật thì Chủ Nhật đầu tiên chỉ có thể là ngày 1, ngày 2 hoặc ngày 3.",
      "Bước 3: Thử 3 trường hợp khả dĩ:\n• Nếu Chủ Nhật đầu tiên là ngày 1 (lẻ): các Chủ Nhật là 1, 8, 15, 22, 29. Các ngày chẵn là 8, 22 (chỉ có 2 ngày).\n• Nếu Chủ Nhật đầu tiên là ngày 2 (chẵn): các Chủ Nhật là 2, 9, 16, 23, 30. Các ngày chẵn là 2, 16, 30 (đúng 3 ngày chẵn! Thỏa mãn đề bài).\n• Nếu Chủ Nhật đầu tiên là ngày 3 (lẻ): các Chủ Nhật là 3, 10, 17, 24, 31. Các ngày chẵn là 10, 24 (chỉ có 2 ngày).\n\nKết luận: Ngày Chủ Nhật đầu tiên của tháng 8 là ngày 2. Do đó, ngày Chủ Nhật tiếp theo (2 + 7 = 9) chính là ngày 9 tháng 8.\nVậy ngày 9 tháng 8 là Chủ Nhật.",
    ],
  },
];
